...
/*   Updated: 2023/02/12 18:46:20 by samajat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class tree_iterator
{
    ...
    private:
        friend iterator_type   find_last_node(iterator_type _node) const;
        friend iterator_type   find_first_node(iterator_type _node) const;
    };
