...
static void test_set()
{
    ...
    int arr[] = {1, 2, 3, 4, 5};
    ft::set<int> set3(arr, arr + sizeof(arr) / sizeof(int));
    ft::set<int> set4;
    ft::set<int> set5(set3);
    ...
    // Element Access
    ft::set<int>::iterator it = set3.find(5);
    if (it != set3.end()) {
...
static  void test_stack ()
{
    ...
    ft::stack<int, ft::vector<int> > stack3;
    ft::stack<int> stack4;
    for (int i = 0; i < 10; i++) {
        stack4.push(i);
    }
    ft::stack<int> stack5(stack4);
...
static void test_map() {
    ...
    ft::map<int, char, std::greater<int> > map3;
    ft::map<int, char>::iterator it;
    for (int i = 0; i < 10; i++) {
        map3.insert(ft::make_pair(i, 'a' + i));
    }
    ft::map<int, char> map4(map3.begin(), map3.end());
    
    // Modifiers
    it = map1.insert(ft::make_pair(1, 'a')).first;
    map1.insert(it, ft::make_pair(2, 'b'));
    map1.insert(ft::make_pair(3, 'c'));
    map1.insert (map1.begin(), ft::make_pair(1337, 'c'));
    ...
    ft::pair<ft::map<int, char>::iterator, ft::map<int, char>::iterator> pair_it = map1.equal_range(2);
...
ft::vector<int>::allocator_type myAllocator = Vect .get_allocator();
